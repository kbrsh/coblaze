	...
	ImageClassificationModel.prototype.load = function() {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_d) {
				switch (_d.label) {
					case 0:
						return [4 /*yield*/, fetch(this.signaturePath)]
					case 1:
					...
					case 2:
						...
						;(_c = this.signature.inputs[this.inputKey].shape.slice(
							1,
							3
						)),
							(this.width = _c[0]),
						...
						this.version =
							this.signature.export_model_version || LEGACY_VERSION
						if (
							!this.version ||
							!SUPPORTED_VERSIONS.includes(this.version)
						) {
							versionMessage =
								"The model version " +
								this.version +
								" you are using for this starter project may not be compatible with the supported versions " +
								SUPPORTED_VERSIONS +
								". Please update both this starter project and Lobe to latest versions, and try exporting your model again. If the issue persists, please contact us at lobesupport@microsoft.com"
				...
				switch (_b.label) {
					case 0:
						...
						confidencesTensor = tf.tidy(function() {
							...
							var croppedImage = tf.image.cropAndResize(
								batchImage,
							...
							if (_this.model) {
								return _this.model.execute(
									((_a = {}),
									(_a[
										_this.signature.inputs[_this.inputKey].name
									] = croppedImage),
									_a),
									_this.outputName
								)
					...
					case 1:
						...
						return [
							2 /*return*/,
							((_a = {}),
							(_a[this.outputKey] = this.labels.reduce(function(
								returnConfidences,
								label,
								idx
							) {
								...
								return __assign(
									((_a = {}),
									(_a[label] = confidencesArray_1[idx]),
									_a),
									returnConfidences
								)
							},
					...
					case 3:
						console.error(
							"Model not loaded, please await this.load() first."
						)
						_b.label = 4
					case 4:
						return [2 /*return*/]
...
const load = (signaturePath, modelPath) => {
	dispose()
...
const predict = data => {
	if (model) return model.predict(data)
}
