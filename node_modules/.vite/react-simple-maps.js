...
var projections = objectWithoutProperties(src_exports, ["geoPath"]);
...
var MapProvider = function MapProvider2(_ref2) {
  ...
  var _ref3 = projectionConfig.center || [], _ref4 = slicedToArray(_ref3, 2), cx = _ref4[0], cy = _ref4[1];
  var _ref5 = projectionConfig.rotate || [], _ref6 = slicedToArray(_ref5, 3), rx = _ref6[0], ry = _ref6[1], rz = _ref6[2];
  var _ref7 = projectionConfig.parallels || [], _ref8 = slicedToArray(_ref7, 2), p1 = _ref8[0], p2 = _ref8[1];
...
function useGeographies(_ref) {
  ...
  var _useState = (0, import_react.useState)({}), _useState2 = slicedToArray(_useState, 2), output = _useState2[0], setOutput = _useState2[1];
...
var Geographies = function Geographies2(_ref) {
  var geography = _ref.geography, children2 = _ref.children, parseGeographies = _ref.parseGeographies, _ref$className = _ref.className, className = _ref$className === void 0 ? "" : _ref$className, restProps = objectWithoutProperties(_ref, ["geography", "children", "parseGeographies", "className"]);
  var _useContext = (0, import_react.useContext)(MapContext), path = _useContext.path, projection2 = _useContext.projection;
  var _useGeographies = useGeographies({geography, parseGeographies}), geographies = _useGeographies.geographies, outline = _useGeographies.outline, borders = _useGeographies.borders;
  return import_react.default.createElement("g", _extends({className: "rsm-geographies " + className}, restProps), geographies && geographies.length > 0 && children2({geographies, outline, borders, path, projection: projection2}));
};
...
function useZoomPan(_ref) {
  ...
  var _center = slicedToArray(center, 2), lon = _center[0], lat = _center[1];
  var _useState = (0, import_react.useState)({x: 0, y: 0, k: 1}), _useState2 = slicedToArray(_useState, 2), position = _useState2[0], setPosition = _useState2[1];
  var lastPosition = (0, import_react.useRef)({x: 0, y: 0, k: 1});
  var mapRef = (0, import_react.useRef)();
  var zoomRef = (0, import_react.useRef)();
  var bypassEvents = (0, import_react.useRef)(false);
  var _translateExtent = slicedToArray(translateExtent, 2), a = _translateExtent[0], b = _translateExtent[1];
  var _a = slicedToArray(a, 2), a1 = _a[0], a2 = _a[1];
  var _b = slicedToArray(b, 2), b12 = _b[0], b22 = _b[1];
  var _scaleExtent = slicedToArray(scaleExtent, 2), minZoom = _scaleExtent[0], maxZoom = _scaleExtent[1];
  (0, import_react.useEffect)(function() {
    var svg = select_default2(mapRef.current);
    function handleZoomStart(d3Event) {
      if (!onMoveStart || bypassEvents.current)
        return;
      onMoveStart({coordinates: projection2.invert(getCoords(width, height, d3Event.transform)), zoom: d3Event.transform.k}, d3Event);
    }
    function handleZoom(d3Event) {
      if (bypassEvents.current)
        return;
      var transform2 = d3Event.transform, sourceEvent = d3Event.sourceEvent;
      setPosition({x: transform2.x, y: transform2.y, k: transform2.k, dragging: sourceEvent});
      if (!onMove)
        return;
      onMove({x: transform2.x, y: transform2.y, k: transform2.k, dragging: sourceEvent}, d3Event);
    }
    function handleZoomEnd(d3Event) {
      ...
      var _projection$invert = projection2.invert(getCoords(width, height, d3Event.transform)), _projection$invert2 = slicedToArray(_projection$invert, 2), x = _projection$invert2[0], y = _projection$invert2[1];
...
var ZoomableGroup = function ZoomableGroup2(_ref) {
  ...
  var _useZoomPan = useZoomPan({
    ...
    translateExtent,
    zoom
  }), mapRef = _useZoomPan.mapRef, transformString = _useZoomPan.transformString;
  return import_react.default.createElement("g", {ref: mapRef}, import_react.default.createElement("rect", {width, height, fill: "transparent"}), import_react.default.createElement("g", _extends({transform: transformString, className: "rsm-zoomable-group " + className}, restProps)));
};
...
var Sphere = function Sphere2(_ref) {
  ...
  return import_react.default.createElement(import_react.Fragment, null, import_react.default.createElement("defs", null, import_react.default.createElement("clipPath", {id: id2}, import_react.default.createElement("path", {d: spherePath}))), import_react.default.createElement("path", _extends({
    d: spherePath,
    fill,
    stroke,
    strokeWidth,
...
var Marker = function Marker2(_ref) {
  ...
  var _useState = (0, import_react.useState)(false), _useState2 = slicedToArray(_useState, 2), isPressed = _useState2[0], setPressed = _useState2[1];
  var _useState3 = (0, import_react.useState)(false), _useState4 = slicedToArray(_useState3, 2), isFocused = _useState4[0], setFocus = _useState4[1];
  var _projection = projection2(coordinates2), _projection2 = slicedToArray(_projection, 2), x = _projection2[0], y = _projection2[1];
  function handleMouseEnter(evt) {
    setFocus(true);
    if (onMouseEnter)
      onMouseEnter(evt);
...
var Annotation = function Annotation2(_ref) {
  var subject = _ref.subject, children2 = _ref.children, connectorProps = _ref.connectorProps, _ref$dx = _ref.dx, dx = _ref$dx === void 0 ? 30 : _ref$dx, _ref$dy = _ref.dy, dy = _ref$dy === void 0 ? 30 : _ref$dy, _ref$curve = _ref.curve, curve = _ref$curve === void 0 ? 0 : _ref$curve, _ref$className = _ref.className, className = _ref$className === void 0 ? "" : _ref$className, restProps = objectWithoutProperties(_ref, ["subject", "children", "connectorProps", "dx", "dy", "curve", "className"]);
  var _useContext = (0, import_react.useContext)(MapContext), projection2 = _useContext.projection;
  ...
  }, restProps), import_react.default.createElement("path", _extends({d: connectorPath, fill: "transparent", stroke: "#000"}, connectorProps)), children2);
};
